...
dummy_implants = [
    {"name": "St. Jude Medical Pacemaker", "common": "Marcapasos Cardiaco Implantable", "reg": "INVIMA-2023DM-001"},
    {"name": "Titanium Orthopedic Screw O-91", "common": "Tornillo de Fijación Ósea", "reg": "INVIMA-2022DM-005"},
    {"name": "Aura Intraocular Lens Plus", "common": "Lente Intraocular Acrílico", "reg": "INVIMA-2024DM-009"},
    {"name": "Biomedical Surgical Suture Silk 3-0", "common": "Sutura Quirúrgica No Absorbible", "reg": "INVIMA-2021DM-002"},
    {"name": "Medtronic Heart Valve BioPro", "common": "Válvula Cardiaca Biológica", "reg": "INVIMA-2025DM-012"}
]

surgeons = ["Dr. Alejandro Restrepo", "Dra. Maria Camila Hoyos", "Dr. Carlos Eduardo Mejia"]
...
def seed_random_data():
    ...
    for i in range(10):  # Generates 10 random entries
        ...
        if response.status_code == 201:
            data = response.json()
            print(f"✅ Saved successfully: {data['implant_name']} -> Classified as: {data['risk_class']}")
        else:
